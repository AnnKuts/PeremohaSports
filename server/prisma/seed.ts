...
export async function main() {
  ...
  const contacts = await Promise.all([
    prisma.contact_data.create({
      data: { phone: '380501112233', email: 'ivan.petrenko@example.com' }
    }),
    prisma.contact_data.create({
      data: { phone: '380671234567', email: 'olena.ivanova@example.com' }
    }),
    prisma.contact_data.create({
      data: { phone: '380931112244', email: 'oleh.koval@example.com' }
    }),
    prisma.contact_data.create({
      data: { phone: '380631231231', email: 'maria.bondar@example.com' }
    }),
    prisma.contact_data.create({
      data: { phone: '380991111222', email: 'serhiy.melnyk@example.com' }
    }),
    prisma.contact_data.create({
      data: { phone: '380681234587', email: 'anna.shevchenko@example.com' }
    })
  ]);
    ...
    data: [
      {
        ...
        last_name: 'Петренко',
        gender: 'male',
        contact_data_id: contacts[0].contact_data_id
      },
      {
        first_name: 'Олена',
        last_name: 'Іванова',
        gender: 'female',
        contact_data_id: contacts[1].contact_data_id
      },
      {
        first_name: 'Олег',
        last_name: 'Коваль',
        gender: 'male',
        contact_data_id: contacts[2].contact_data_id
      },
      {
        first_name: 'Марія',
        last_name: 'Бондар',
        gender: 'female',
        contact_data_id: contacts[3].contact_data_id
      }
    ]
  });
    ...
    data: [
      {
        ...
        last_name: 'Мельник',
        is_admin: true,
        contact_data_id: contacts[4].contact_data_id
      },
      {
        first_name: 'Анна',
        last_name: 'Шевченко',
        is_admin: false,
        contact_data_id: contacts[5].contact_data_id
      }
    ]
  });
