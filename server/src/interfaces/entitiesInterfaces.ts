export interface IAttendanceRepository {
  ...
  getSessionWithRoomAndClassType(
    sessionId: number
  ): Promise<{ room_id: number; class_type_id: number } | null>;
...
export interface IClassTypeRepository {
  ...
  findAll(options?: {
    ...
    limit?: number;
    offset?: number;
  }): Promise<{ classTypes: any[]; total: number }>;
  ...
  getMonthlyRevenueByClassType(options?: {
    minRevenue?: number;
