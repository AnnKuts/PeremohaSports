...
router.post(
  ...
  authenticate,
  requireAdmin,
  validate(createRoomClassTypeSchema),
  roomController.createRoomClassType
);
router.delete(
  '/:id',
  authenticate,
...
router.put(
  ...
  authenticate,
  requireAdmin,
  validate(updateRoomCapacitySchema),
  roomController.updateRoomCapacity
);
router.get(
  '/analytics/room-revenue',
  authenticate,
  requireAdmin,
  validate(getRoomRevenueAndAttendanceSchema),
  roomController.getRoomRevenueAndAttendance
);
