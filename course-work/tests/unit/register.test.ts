...
describe("RegisterService (unit)", () => {
    ...
    it("register: throws if user already exists", async () => {
        ...
        await expect(registerService.register(validData)).rejects.toThrow("Email or phone already exists");
    });
    ...
    it("register: success", async () => {
        ...
        (registerRepository.registerWithTransaction as any).mockResolvedValue({ clientId: 1, paymentId: 1 });
