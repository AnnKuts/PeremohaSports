...
router.post("/admin/trainers", authenticate, requireAdmin,validate(createTrainerSchema), TrainersController.createTrainer);

router.delete("/admin/trainers/:id", authenticate, requireAdmin,validate(trainerIdParamSchema), TrainersController.deleteTrainer);

router.patch("/admin/trainers/:id", authenticate, requireTrainerOwnerOrAdmin,validate(trainerIdParamSchema), validate(updateTrainerSchema), TrainersController.updateTrainer);
